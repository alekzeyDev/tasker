...
class Request extends Core
{
     ...
     * например, чтобы получить имя загруженного файла: $filename = $api->request->files('myfile', 'name');
     */
    ...
    public function session_get($key, $defaultValue = [])
    {
    ...
    {
        $session = $this->session_get($key);
        $session = array_merge($session, $value);
